...
function selectTravelDestination(destination_name)
{
    ...
    if(selected_destination !== undefined)
    {
        ...
        document.getElementById("selected_dest_flagpath").src=selected_destination.flagpath;
        document.getElementById("selected_dest_imagepath").style.opacity ="1";
        document.getElementById("selected_dest_language").textContent=selected_destination.language;
        document.getElementById("selected_dest_population").textContent=selected_destination.population;
        document.getElementById("selected_dest_area").textContent=selected_destination.area;
...
function populateTDMap()
{
    ...
    travelDestMap.set('Algerien', {
        ...
        language: "Arabisch, Tamazight", 
        population: "45,77 Mio.",
        area: "2.381.741 km²"
        }
    );
